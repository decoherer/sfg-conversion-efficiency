...
We can define the coupled wave equations in convenient units as follows:

dE₁/dz = -i √η exp(–i Δk z) E₃ E₂<sup>*</sup>  (λ₃/λ₁)

dE₂/dz = -i √η exp(–i Δk z) E₃ E₁<sup>*</sup>  (λ₃/λ₂)

dE₃/dz = -i √η exp(+i Δk z) E₁ E₂

where Pᵢ(z) = Eᵢ<sup>*</sup> (z)Eᵢ(z) is the power vs distance for each wavelength, z is in cm, Δk is in cm⁻¹, and η is the SFG conversion efficiency in %/W/cm².  

Optical parametric amplification
--------------------------------

Solving the coupled wave equations for E₃ = constant (undepleted pump assumption), E₁(0) = 0, E₂(0) = √P₀, and Δk=0, we find

d²E₁/dz² = γ² E₁

d²E₂/dz² = γ² E₂

γ² = η E₃<sup>*</sup>E₃ (λ₃/λ₁) (λ₃/λ₂) = η P₃ (λ₃/λ₁) (λ₃/λ₂)

The general solution is Eᵢ(z) = aᵢ exp(+γz) + bᵢ exp(–γz), and given the initial conditions the solution for power vs distance is

P₁(z) = P₀ (λ₂/λ₁) sinh²(γz)

P₂(z) = P₀ cosh²(γz) = P₀ (1+sinh²(γz))

Let’s consider a pulsed pump input at λ₃ with pulse energy ρ and pulse duration τ, and a cw seed at λ₂ with power P₀. To get to pump depletion levels, i.e. in which a significant fraction of the pump pulse energy is converted to λ₁ and λ₂, requires that the seed power is amplified to the scale of the pulse peak power, P₃ ≈ ρ/τ:

P₀ cosh²(γL) ≈ P₃

Solving for γL we have γL = cosh⁻¹√(P₃/P₀), or

η L² = (1/P₃) (λ₁/λ₃) (λ₂/λ₃) [cosh⁻¹√(P₃/P₀)]²

As specific example, assume P₀ = 1mW, ρ = 1nJ, τ = 1ps, and (λ₁/λ₃)(λ₂/λ₃) ≈ 4. Then P₃ = 1kW, P₃/P₀ ≈ 10⁶, and η L² ≈ (1/P₃) 4 [cosh⁻¹(10³)]² = 23%/W. Keep in mind that L must be less than the walkoff distance.

One often sees the gain defined as
